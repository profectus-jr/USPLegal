...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: estacionamento)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: entradas_e_saidas)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: desniveis)
...
consPorta = ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: portas_e_aberturas)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: rampa)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: escada_e_degraus_isolados)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: elevador_de_passageiros)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: elevador_exclusivo_para_pessoa_com_deficiencia)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: plataforma_elevatoria)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: escada_rolante)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: esteira_rolante)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: boxe_adaptado_de_sanitarios)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: bacia_sanitaria)
...
consLav = ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: lavatorio)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: mictorios)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: chuveiro)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: banheira)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: vestiarios)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: rotas_de_fuga)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: locais_de_reuniao)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: locais_de_hospedagem)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: servicos_de_saude)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: copa_e_cozinha)
...
ChecklistItem.create(question: "O equipamento está conservado? ", equip_type: locais_de_esporte_lazer_e_turismo)
...
IOPrincipal = Building.create(idAtlas: "3911", name: "IO-Edifício Principal-191")
EPServicos = Building.create(idAtlas: "4719", name: "EP-Serviços Gerais-908")
EP_ENERQ =Building.create(idAtlas: "4713", name: "EP-ENERQ-158")
Building.create(idAtlas: "118" , name: "FMVZ-BLOCO 9-240")
Building.create(idAtlas: "4668", name: "FMVZ-BIOTÉRIO DE AVES-GALPÃO 1-240")
Building.create(idAtlas: "4669", name: "FMVZ-BIOTÉRIO DE AVES-GALPÃO 2-240")
Building.create(idAtlas: "4670", name: "FMVZ-BIOTÉRIO DE AVES-GALPÃO 3-240")
Building.create(idAtlas: "4656", name: "IB-BIBLIOTECA E CENTRO DIDÁTICO-SN")
Building.create(idAtlas: "4706", name: "IGC-Garagem e Centro de Vivência-562")
Building.create(idAtlas: "5006", name: "MAE-CORREIOS-1466")
Building.create(idAtlas: "4572", name: "FAU-Edifício Villanova Antigas-876")
Building.create(idAtlas: "4676", name: "FFLCH-Casa de Cultura Japonesa-159")
Building.create(idAtlas: "4677", name: "RUSP-Almoxarifado Codage-270")
Building.create(idAtlas: "4593", name: "IQ-Bloco 11-748")
Building.create(idAtlas: "5", name: "FFLCH-Administração-717")
Building.create(idAtlas: "4594", name: "IQ-Bloco 12-748")
Building.create(idAtlas: "4592", name: "IQ-Bloco 10-748")
Building.create(idAtlas: "4589", name: "IQ-Bloco 07-748")
Building.create(idAtlas: "4582", name: "IQ-Bloco 00-748")
Building.create(idAtlas: "4588", name: "IQ-Bloco 06-748")
Building.create(idAtlas: "4586", name: "IQ-Bloco 04-748")
Building.create(idAtlas: "4591", name: "IQ-Bloco 09-748")
Building.create(idAtlas: "4808", name: "EP-Bloco A-128")
Building.create(idAtlas: "4812", name: "EP-Bloco C-128")
Building.create(idAtlas: "4806", name: "EP-Produção Blocos F e G-471")
Building.create(idAtlas: "4741", name: "Edifício Anexo-Museu de Arqueologia e Etnologia-1466")
Building.create(idAtlas: "4651", name: "MAC-MAC Exposições-160")
Building.create(idAtlas: "4653", name: "MAC-Manutenção-160")
Building.create(idAtlas: "4595", name: "Centro de Vivência da Reitoria-Centro de Vivência-74")
Building.create(idAtlas: "4576", name: "FO-Clínicas A,B e C-2227")
Building.create(idAtlas: "4326", name: "ECA-Edifício do Departamento de Música-443")
Building.create(idAtlas: "4569", name: "ECA-Bloco B-443")
Building.create(idAtlas: "4322", name: "ECA-Artes Cênicas-443")
Building.create(idAtlas: "4273", name: "ECA-Teatro Laboratório-215")
Building.create(idAtlas: "4568", name: "ECA-Bloco A-80")
Building.create(idAtlas: "4570", name: "ECA-Bloco C-443")
Building.create(idAtlas: "4567", name: "Restaurante-Restaurante do Instituto de Física, Lanchonete e Centro Acadêmica-123")
Building.create(idAtlas: "4725", name: "EP-Edifício da Administração-380")
Building.create(idAtlas: "4574", name: "FE-Escola de Aplicação Bloco A e B-220")
Building.create(idAtlas: "4644", name: "CEPEUSP-Vestiário das Piscinas-61")
Building.create(idAtlas: "4645", name: "CEPEUSP-Vestiário Masculino-61")
Building.create(idAtlas: "4680", name: "CEPEUSP-Lanchonete-61")
Building.create(idAtlas: "4648", name: "CEPEUSP-Vestiário Feminino-61")
Building.create(idAtlas: "4649", name: "CEPEUSP-Bloco G-61")
Building.create(idAtlas: "4646", name: "CEPEUSP-Bloco B-61")
Building.create(idAtlas: "4647", name: "CEPEUSP-Bloco D-61")
Building.create(idAtlas: "4650", name: "CEPEUSP-Bloco F-61")
Building.create(idAtlas: "4692", name: "IF-Depto. Física Experimental - Lab. Fis. Plasmas-187")
Building.create(idAtlas: "4742", name: "Galpão de Exposições-Edifício Antigo da UEP-1466")
Building.create(idAtlas: "5000", name: "MAE-Oficina de Manutenção-1466")
Building.create(idAtlas: "4", name: "FFLCH-Biblioteca Central-350")
Building.create(idAtlas: "4573", name: "FAU-Laboratório de Marcenaria e Gráfica-876")
Building.create(idAtlas: "4728", name: "EP-CTCC Centro de Técnicas de Construção Civil-115")
Building.create(idAtlas: "4809", name: "EP-Biênio Anfiteatros-128")
Building.create(idAtlas: "4720", name: "EP-Biênio Bloco D3-128")
Building.create(idAtlas: "4722", name: "EP-Biênio Bloco D1-128")
Building.create(idAtlas: "5001", name: "MAE-Oficina de Manutenção-1466")
Building.create(idAtlas: "1", name: "FFLCH-História e Geografia-338")
Building.create(idAtlas: "4810", name: "EP-Edifício da Engenharia Civil-83")
Building.create(idAtlas: "4710", name: "CCE-Blocos A, B e C-1721")
Building.create(idAtlas: "4659", name: "IB-Vestiário-SN")
Building.create(idAtlas: "4661", name: "IB-Laboratório-SN")
Building.create(idAtlas: "4662", name: "IB-Estufa-SN")
Building.create(idAtlas: "506", name: "IB-Estufa-SN")
Building.create(idAtlas: "4727", name: "EP-Edifício da Engenharia Mecânica-2231")
Building.create(idAtlas: "4716", name: "EP-Serviços Gerais, Blocos 13 e 14- SN")
Building.create(idAtlas: "4714", name: "EP-Engenharia Elétrica, Galpão Didático-1100")
Building.create(idAtlas: "4718", name: "EP-LSI Laboratório de Sistemas Integrados-158")
Building.create(idAtlas: "4715", name: "EP-PEA, Bloco 30-SN")
Building.create(idAtlas: "4702", name: "FEA-FEA 6, Bloco 6-748")
Building.create(idAtlas: "4703", name: "FEA-Pavilhão III, Bloco 3-748")
Building.create(idAtlas: "2", name: "FFLCH-Edifício das Letras-403")
Building.create(idAtlas: "1570", name: "EP-Engenharia Química, Bloco 21-350")
Building.create(idAtlas: "1549", name: "EP-Engenharia Química, Bloco 20-350")
Building.create(idAtlas: "1332", name: "EP-Engenharia Química, Bloco 19-350")
Building.create(idAtlas: "1023", name: "EP-Engenharia Química, Bloco 18-350")
Building.create(idAtlas: "4681", name: "IO-Manutenção-191")
Building.create(idAtlas: "4704", name: "FEA-Pavilhão II, Bloco 2-908")
Building.create(idAtlas: "4807", name: "EP-Engenharia Elétrica, Prédio-1100")
Building.create(idAtlas: "4663", name: "IB-ANDRÉ DREYFUS-277")
Building.create(idAtlas: "303", name: "IB-LABORATÓRIO DE BOTÂNICA-SN")
Building.create(idAtlas: "302", name: "IB-ANFITEATRO DO EDIFÍCIO ANDRÉ DREYFUS-277")
Building.create(idAtlas: "190", name: "IB-EDIFÍCIO DO GENOMA HUMANO-106")
Building.create(idAtlas: "3", name: "FFLCH-Edifício da Filosofia e Ciências Sociais-SN")
Building.create(idAtlas: "4494", name: "EP-Engenharia de Metalurgia e de Materiais-2463")
Building.create(idAtlas: "4723", name: "EP-Centro Moraes Rego, Departamento de Metalurgia-2463")
Building.create(idAtlas: "4724", name: "EP-Engenharia de Minas e Petróleo-2373")
Building.create(idAtlas: "4682", name: "FEA-Biblioteca-508")
Building.create(idAtlas: "994", name: "Semi-Industrial- Rua do Lago -250")
Building.create(idAtlas: "509", name: "Biotério e Almoxarifado-Avenida Prof. Lineu Prestes-580")
Building.create(idAtlas: "5002", name: "MAE-Depósito e Pintura DMP-1466")
...
Building.create(idAtlas: "4701", name: "FEA-Salas de Aula FAZESP, Bloco 5-508")
Building.create(idAtlas: "4279", name: "ECA-Biblioteca e Administração, Bloco D-443")
Building.create(idAtlas: "4311", name: "ECA-Artes Cênicas, Bloco Didático-443")
Building.create(idAtlas: "4331", name: "ECA-Artes Plásticas-151")
Building.create(idAtlas: "4571", name: "ECA-Depósito de Artes Plásticas-151")
Building.create(idAtlas: "4392", name: "IP-Professores e Laboratórios de Pesquisa, Blocos A e F-1721")
Building.create(idAtlas: "4344", name: "IP-Oficinas, Bloco E-1271")
Building.create(idAtlas: "4407", name: "IP-Biblioteca, Bloco C-1721")
Building.create(idAtlas: "687", name: "IB-Anfiteatro do Edifício Ernest Marcus-101")
Building.create(idAtlas: "4353", name: "IP-Atendimento, Bloco D-1721")
Building.create(idAtlas: "5009", name: "MAE-Bloco A-1280")
Building.create(idAtlas: "4581", name: "IME-Bloco B-1010")
Building.create(idAtlas: "4577", name: "ICB-Edifício Didático de Anatomia-2361")
Building.create(idAtlas: "157", name: "ICB-BIO I-2415")
Building.create(idAtlas: "5005", name: "MAE-Galpão DMP-1466")
Building.create(idAtlas: "4596", name: "FMVZ-Hospital dos Equinos-240")
Building.create(idAtlas: "4587", name: "IQ-Bloco 05-748")
Building.create(idAtlas: "4584", name: "IQ-Bloco 02-748")
Building.create(idAtlas: "4583", name: "IQ-Bloco 01-748")
Building.create(idAtlas: "179", name: "ICB-ICB II, Bloco didático-1374")
Building.create(idAtlas: "5004", name: "MAE-Restaurante e Vestiário-1466")
Building.create(idAtlas: "4430", name: "IP-Sala de Aula, Bloco B-1721")
Building.create(idAtlas: "4575", name: "FE-Escola de Aplicação, Ensino Médio, Bloco C-220")
Building.create(idAtlas: "4709", name: "STI-Edifício anexo do CTI-51")
Building.create(idAtlas: "4654", name: "IB-Ecologia Geral, Fisiologia e Zoologia-101")
Building.create(idAtlas: "4655", name: "IB-Restaurante-SN")
Building.create(idAtlas: "4657", name: "IB-Apiário-SN")
Building.create(idAtlas: "4658", name: "IB-Laboratório-SN")
Building.create(idAtlas: "4660", name: "IB-Laboratório de Botânica-SN")
Building.create(idAtlas: "4675", name: "ICB-Manutenção-SN")
Building.create(idAtlas: "173", name: "ICB-ICB II-1374")
Building.create(idAtlas: "148", name: "ICB-ICB IV-1730")
Building.create(idAtlas: "4731", name: "IB-Salas de Aula, Félix Rawscher-277")
Building.create(idAtlas: "396",  name: "ICB-Museu de Anatomia Humana, ICB III-2415")
Building.create(idAtlas: "10", name: "EP-Engenharia Química, Bloco 22-350")
Building.create(idAtlas: "4683", name: "MAE-Centro de Informações/Visitantes-SN")
Building.create(idAtlas: "4743", name: "Manutenção-Sem descrição-1466")
Building.create(idAtlas: "4805", name: "CEPEUSP-Estádio Olímpico-875")
Building.create(idAtlas: "4066", name: "CEPEUSP-Velódromo-601")
Building.create(idAtlas: "4639", name: "CEPEUSP-Módulos Poliesportivos, Quadras Cobertas-61")
Building.create(idAtlas: "4566", name: "SAS-Creche Oeste-1280")
Building.create(idAtlas: "4091", name: "SAS-Restaurante Central-300")
Building.create(idAtlas: "4638", name: "SAS-Creche Central-200")
Building.create(idAtlas: "4643", name: "FE-Edifício Principal, Bloco B-308")
Building.create(idAtlas: "4737", name: "FE-Biblioteca, Bloco B-308")
Building.create(idAtlas: "679" , name: "Q-Auditórios, Bloco 25-748")
Building.create(idAtlas: "4590", name: "IQ-Bloco 8-748")
Building.create(idAtlas: "4585", name: "IQ-Bloco 3-748")
Building.create(idAtlas: "3108", name: "EEFE-Bloco didático (B) e Quadras (C)-65")
Building.create(idAtlas: "4642", name: "EEFE-Garagem Coberta-65")
Building.create(idAtlas: "4641", name: "EEFE-Bloco A-65")
Building.create(idAtlas: "4640", name: "EEFE-Restaurante-65")
Building.create(idAtlas: "4717", name: "EP-Biênio, Bloco D2-471")
Building.create(idAtlas: "953", name: "SAU-Ciências Farmacêuticas, Bloco 17-580")
Building.create(idAtlas: "873", name: "SAU-Ciências Farmacêuticas, Bloco 16-580")
Building.create(idAtlas: "831", name: "SAU-Ciências Farmacêuticas, Bloco 15-580")
Building.create(idAtlas: "771", name: "SAU-Ciências Farmacêuticas, Bloco 14-580")
Building.create(idAtlas: "723", name: "SAU-Ciências Farmacêuticas, Bloco 13-580")
Building.create(idAtlas: "733", name: "SAU-Análises Clínicas e Toxicológicas, Bloco 13A-580")
Building.create(idAtlas: "717", name: "SAU-Administração, Bloco 13B-875")
Building.create(idAtlas: "4736", name: "FM-Paramédicas (Fono/Fisio/TO), Bloco 1 e 2-51")
Building.create(idAtlas: "4664", name: "FMVZ-Clínica Veterinária, Dermatologia e Cardiologia, Blocos 12 e 14-240")
Building.create(idAtlas: "4665", name: "FMVZ-Clínica Veterinária, Administração, Blocos 13 e 15-240")
Building.create(idAtlas: "4666", name: "Hospital Veterinário-Triagem-240")
Building.create(idAtlas: "4901", name: "IEE-Edifício Didático-1289")
Building.create(idAtlas: "4902", name: "IEE-Edifício Didático-1289")
Building.create(idAtlas: "4729", name: "IQ-Depósito de Produtos Químicos-748")
Building.create(idAtlas: "221" , name: "IQ-Biblioteca-748")
Building.create(idAtlas: "4739", name: "MAE-Edifício Principal-1466")
Building.create(idAtlas: "4505", name: "FMVZ-Bloco 17-240")
Building.create(idAtlas: "4667", name: "FMVZ-Grêmio dos Funcionários-240")
Building.create(idAtlas: "4707", name: "FMVZ-VCI, Edifício Vicente Boreli-240")
Building.create(idAtlas: "4708", name: "FMVZ-Museu de Anatomia Veterinária e Canil da Anatomia-240")
Building.create(idAtlas: "123", name: "FMVZ-Blocos Complementares-240")
Building.create(idAtlas: "126", name: "FMVZ-Laboratório de Inseminação Artificial, Bloco 19-240")
Building.create(idAtlas: "4916", name: "IEE-Salão de Máquinas Rotativas-1289")
Building.create(idAtlas: "4913", name: "IEE-Grêmio dos Funcionários-1289")
Building.create(idAtlas: "4690", name: "IF-Edifício Principal-186")
Building.create(idAtlas: "4691", name: "IF-Conjunto Abrahão de Moraes, Bloco A-123")
Building.create(idAtlas: "4684", name: "IF-Auditório de Física Experimental, Adma Jafet-187")
Building.create(idAtlas: "4600", name: "FMVZ-Anexo do Bloco 17-240")
Building.create(idAtlas: "4671", name: "FMVZ-Canil-240")
Building.create(idAtlas: "4672", name: "FMVZ-Patologia Suína-240")
Building.create(idAtlas: "4599", name: "FMVZ-Galpão de Ruminantes-240")
Building.create(idAtlas: "4598", name: "FMVZ-Galpão de Aves-240")
Building.create(idAtlas: "4636", name: "FO-Oficina e Lavanderia-2227")
Building.create(idAtlas: "4637", name: "FO-Garagem-2227")
Building.create(idAtlas: "4635", name: "FO-Restaurante-2227")
Building.create(idAtlas: "4634", name: "FO-Recepção-2227")
Building.create(idAtlas: "4633", name: "FO-Fundação de Odontologia-2227")
Building.create(idAtlas: "4801", name: "IAG-Biblioteca e Administração-1226")
Building.create(idAtlas: "4802", name: "IAG-Blocos C e D-1226")
Building.create(idAtlas: "4800", name: "IAG-Edifício Principal-1226")
Building.create(idAtlas: "4803", name: "IAG-Blocos A, B e E-1226")
Building.create(idAtlas: "4900", name: "IEE-Metrologia, Ensino e Pesquisa-1289")
Building.create(idAtlas: "4903", name: "IEE-Laboratório de Materiais-1289")
Building.create(idAtlas: "4904", name: "IEE-Oficinas-1289")
Building.create(idAtlas: "4905", name: "IEE-Laboratório de Fundamentos de Energia-1289")
Building.create(idAtlas: "4906", name: "IEE-Laboratório de Conservação de Energia-1289")
Building.create(idAtlas: "4907", name: "IEE-Laboratório de Sistemas Fotovoltáicos-1289")
Building.create(idAtlas: "4908", name: "IEE-Laboratório de Sistemas Fotovoltáicos-1289")
Building.create(idAtlas: "4910", name: "IEE-Edifício da Administração e Almoxarifado Central-1289")
Building.create(idAtlas: "4911", name: "IEE-Pavilhão de Máquinas-1289")
Building.create(idAtlas: "4915", name: "IEE-Edifício de Subestações Compactas-1289")
Building.create(idAtlas: "4912", name: "IEE-Laboratório de Pilhas e Acumuladores-1289")
Building.create(idAtlas: "4601", name: "IF-Edifício Basílio Jafet-187")
Building.create(idAtlas: "4694", name: "IF-Oficina Central, Edifício Van der Graaf-187")
Building.create(idAtlas: "11", name: "IF-Laboratório de Radiação e Alta Tensão-187")
Building.create(idAtlas: "4695", name: "IF-Sociedade Brasileira de Física-187")
Building.create(idAtlas: "4696", name: "IF-Laboratório de Física Experimental-187")
Building.create(idAtlas: "4697", name: "IF-Laboratório de Dosimetria-187")
Building.create(idAtlas: "4579", name: "IF-Bloco C-187")
Building.create(idAtlas: "4700", name: "IF-Laboratório de Física dos Materiais-187")
Building.create(idAtlas: "14", name: "IF-Auditório, Bloco E-187")
Building.create(idAtlas: "4740", name: "Sem Descrição-Sanitários-1466")
Building.create(idAtlas: "3784", name: "IGC-Edifício Principal e Biblioteca-562")
Building.create(idAtlas: "4733", name: "IME-Bloco C-1010")
Building.create(idAtlas: "4121", name: "IME-Bloco A-1010")
Building.create(idAtlas: "4285", name: "PRCEU-Anfiteatro de Convenções Camargo Guarnieri-109")
Building.create(idAtlas: "5007", name: "MAE-Arquivo da Reitoria-SN")
Building.create(idAtlas: "4674", name: "RUSP-Anexo do PRCEU e do Conselho Universitário-109")
Building.create(idAtlas: "4673", name: "RUSP-SAUSP,Rua Francisco dos Santos-SN")
Building.create(idAtlas: "4235", name: "RUSP-Colméias, Conjunto A-181")
Building.create(idAtlas: "4678", name: "RUSP-Colméias, Conjuntos C e D-181")
Building.create(idAtlas: "4199", name: "RUSP-Colméias, Conjunto B-181")
Building.create(idAtlas: "12", name: "IF-Departamento de Fisica Nuclear-187")
Building.create(idAtlas: "13", name: "IF-Conjunto Auditório Alessandro Volta, Bloco D-187")
Building.create(idAtlas: "1214", name: "IQ-Centro de Vivência-580")
Building.create(idAtlas: "4679", name: "FE-Bloco A-SN")
Building.create(idAtlas: "4578", name: "IF-Conjunto Alessandro Volta, Bloco F-187")
Building.create(idAtlas: "4699", name: "IF-Conjunto Alessandro Volta, Blocos A e B-187")
Building.create(idAtlas: "4693", name: "IF-Edificio Pelletron-SN")
Building.create(idAtlas: "4698", name: "IF-Instituto do Milênio de Fluidos Complexos-SN")
Building.create(idAtlas: "4711", name: "CCE-Bloco D")
Building.create(idAtlas: "4730", name: "IQ-Interligação Conjunto das Químicas, Circulação Vertical-SN")
Building.create(idAtlas: "4732", name: "ICB-Biotério de Ratos-SN")
Building.create(idAtlas: "4734", name: "IO-Bloco Didático-SN")
Building.create(idAtlas: "4738", name: "EEFE-Bloco de Laboratórios-SN")
Building.create(idAtlas: "4744", name: "Edifício de Serviços-Sem Descrição-SN")
Building.create(idAtlas: "4804", name: "IAG-Blocos F e G-1226")
Building.create(idAtlas: "4712", name: "EP-Tanque de Provas, Eng. Naval-SN")
Building.create(idAtlas: "4914", name: "IEE-Cabine Elétrica-SN")
Building.create(idAtlas: "5011", name: "IGC-Laboratório de Geocronologia-SN")
Building.create(idAtlas: "5010", name: "IGC-Laboratório de Geocronologia-SN")
Building.create(idAtlas: "4630", name: "FO-Edifício Principal-2227")
Building.create(idAtlas: "4652", name: "MAC-Anexo MAC-SN")
Building.create(idAtlas: "4565", name: "IP-Administração, Bloco G-SN")
Building.create(idAtlas: "5013", name: "PRCEU-Biblioteca Brasiliana-SN")
